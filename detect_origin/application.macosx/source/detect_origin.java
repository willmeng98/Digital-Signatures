...
public class detect_origin extends PApplet {
...
public void draw()
{
  ...
  if((mousePressed==true) && (mouseX >0)&&(mouseX < 200) && (mouseY > 0) && (mouseY < 200))
  {
    ...
    endx = mouseX;
    endy = mouseY;
    total_press_time = total_press_time + 0.01f;
...
public void savePicture()
{
  ...
  finalpicture.filter(THRESHOLD, 0.5f);
  ...
  {
    float brightness = red(finalpicture.pixels[i])*0.3f + green(finalpicture.pixels[i])*0.59f + blue(finalpicture.pixels[i])*0.11f;
...
public void mouseReleased() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "detect_origin" };
    if (passedArgs != null) {
