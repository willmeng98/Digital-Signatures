...
void draw()
{
  ...
  if((mousePressed==true) && (mouseX >0)&&(mouseX < 200) && (mouseY > 0) && (mouseY < 200))
  {
    ...
    if(startstroke == false)
    {
      dispx1 = mouseX;
      dispy1 = mouseY;
      startstroke = true;
    }
    total_distance = total_distance + distance(x,y,mouseX,mouseY);
    //print(distance(x,y,mouseX,mouseY));
...
void savePicture()
{
    ...
    for(int i = 0; i < finalpicture.pixels.length;i++)
  {
    ...
    "," + str(starty) + "," + str(endx) + "," + str(endy) + "," + str(total_distance) + "," +
    str(total_distance/total_press_time) + "," + str(total_displacement) + "," + 
    str(total_distance/total_displacement) + "," + str(total_displacement/total_press_time) +
    "," + str(total_displacement/total_press_amount) + "," + str(distance(startx,starty,endx,endy)) + 
    ",";
...
void testPicture()
{
    ...
    str(total_press_time/total_press_amount) + "," + str(startx) + 
    "," + str(starty) + "," + str(endx) + "," + str(endy) + "," + str(total_distance) + "," +
    str(total_distance/total_press_time) + ",";
...
void mouseReleased() {
  ...
  if((mouseX >0)&&(mouseX < 200) && (mouseY > 0) && (mouseY < 200))
  {
    ...
    if(startstroke == true)
    {
      total_displacement = total_displacement + distance(dispx1,dispy1,mouseX,mouseY);
      startstroke = false;
    }
    
    println(total_displacement);
  }
...
{
  //println(sq(x2-x1) + " " + sq(y2-y1) + " " + sqrt(sq(x2-x1)+sq(y2-y1)));
  return sqrt(sq(x2-x1)+sq(y2-y1));
}

void reset() //resets features
{
  total_press_time = 0;
